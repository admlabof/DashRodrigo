...
interface FiltersProps {
  ...
  activeModuleBTab?: "B1" | "B2" | "B3" | "B4" | "B5" | "B6";
...
const Filters: React.FC<FiltersProps> = ({
  ...
  const isSingleMonthMode =
    viewMode === "MODULE_B" && activeModuleBTab === "B2";
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-slate-50 p-1 rounded border">
          <button
            ...
            className="px-3 py-1 text-sm hover:bg-gray-200 rounded text-gray-600"
          >
            &lt; Ano Ant.
          </button>
          ...
          <div className="flex items-center gap-2 border-l pl-4">
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((p) => ({
                  ...p,
                  relatedToFilter: e.target.value as any,
                }))
              }
            >
